...
namespace LightBDD.Execution
{
    ...
    public interface IScenarioBuilder
    {
        ...
        /// [Test]
        /// [Label("Ticket-1")]
        /// public async Task Receiving_invoice_for_products()
        /// {
        ///     await Runner.NewScenario()
        ///         .RunAsync(
        ///             given => Product_is_available_in_product_storage("wooden desk"),
        ...
        /// Expected step signature:
        /// <code>
        /// async Task Product_is_available_in_product_storage(string product) { /* ... */ }
        /// </code>
        /// </summary>
        /// <param name="steps">List of steps to execute in order.</param>
        Task RunAsync(params Expression<Func<StepType, Task>>[] steps);
    }
    ...
    public interface IScenarioBuilder<TContext>
    {
        ...
        /// Expected step signature:
        /// <code>
        /// async Task Given_the_user_is_about_to_login(LoginContext context) { /* ... */ }
        /// </code>
        /// </summary>
        /// <param name="steps">List of steps to execute in order.</param>
        ...
        /// [Test]
        /// [Label("Ticket-5")]
        /// public async Task Should_dispatch_product_after_payment_is_finalized()
        /// {
        ///     await Runner.NewScenario()
        ///         .WithContext&lt;SpeditionContext&gt;()
        ///         .RunAsync(
        ...
        /// Expected step signature:
        /// <code>
        /// async Task The_customer_has_product_in_basket(string product) { /* ... */ }
        /// </code>
        /// </summary>
        /// <param name="steps">List of steps to execute in order.</param>
        Task RunAsync(params Expression<Func<StepType, TContext, Task>>[] steps);
    }
}